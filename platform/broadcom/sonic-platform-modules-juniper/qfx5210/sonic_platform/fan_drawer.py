...
class FanDrawer(FanDrawerBase):
    ...
    def __init__(self, fantray_index):
        ...
        self._fan_list.append(Fan(fantray_index, qfx5210_fans[fantray_index]['fan1'], False, 0))
        self._fan_list.append(Fan(fantray_index, qfx5210_fans[fantray_index]['fan2'], False, 0))
